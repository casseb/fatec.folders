...
#Subtrai o conteudo de um dicionário com uma matriz, trazendo um dicionário subtraido com resultado
...
if(len(mensagensErro)==0):
    ...
    if(pontosJogador1>pontosJogador2):
        saidas.append("1º Colocado: Jogador 1")
        saidas.append("2º Colocado: Jogador 2")
    elif(pontosJogador1<pontosJogador2):
        saidas.append("1º Colocado: Jogador 2")
        saidas.append("2º Colocado: Jogador 1")
    else:
        saidas.append("Jogo Empatado!!!")

    saidas.append(separador)

    saidas.append("Estatísticas Jogador 1")
    ...
    saidas.append("Alvos Parciais que restaram do Adversário: %i"%(31-somandoPontosIndividuais(dicPosicaoFinal2)))
    saidas.append("Alvos Totais que restaram do Adversário: %i"%(13-somandoPontosAfundados(dicPosicaoFinal2)))

    saidas.append(separador)

    saidas.append("Estatísticas Jogador 2")
    ...
    saidas.append("Alvos Parciais que restaram do Adversário: %i"%(31-somandoPontosIndividuais(dicPosicaoFinal1)))
    saidas.append("Alvos Totais que restaram do Adversário: %i"%(13-somandoPontosAfundados(dicPosicaoFinal1)))
